        ...
        <div class="navbar-header">
            ...
            <div class="menu-position right">
                    ...
                    >
                        ...
                        <p>EUROPE, MIDDLE EAST AND AFRICA - EN</p>
                    </a>
                </div>
            </div>
        </div>
...
(function () {
  ...
  // Determine the REST API root once, robustly.
  // If WP prints the rel="https://api.w.org/" link, use it; otherwise fall back to origin + /wp-json.
  const API_ROOT = (() => {
    const link = document.querySelector('link[rel="https://api.w.org/"]');
    if (link && link.href) return link.href.replace(/\/+$/, '');
    return (location.origin + '/wp-json').replace(/\/+$/, '');
  })();

  async function resolvePermalink(slug, type) {
    const kind = (type || 'pages').trim(); // 'pages' by default
    const url = `${API_ROOT}/wp/v2/${encodeURIComponent(kind)}?slug=${encodeURIComponent(slug)}&per_page=1&_fields=link`;
    try {
      const res = await fetch(url, { credentials: 'same-origin' });
      if (!res.ok) throw new Error('HTTP ' + res.status);
      const data = await res.json();
      if (Array.isArray(data) && data[0] && data[0].link) return data[0].link;
    } catch (err) {
      // silently keep fallback href
    }
    return null;
  }

  document.addEventListener('DOMContentLoaded', () => {
    document.querySelectorAll('a.resolve-wp[data-slug]').forEach(async (a) => {
      const slug = a.getAttribute('data-slug');
      const type = a.getAttribute('data-type') || 'pages'; // use 'pages' unless you set data-type
      const resolved = await resolvePermalink(slug, type);
      if (resolved) {
        a.setAttribute('href', resolved);
      } else if (a.dataset.fallback) {
        // optional: <a data-fallback="/powerboats/"> to override if not found
        a.setAttribute('href', a.dataset.fallback);
      }
    });
  });
})();
                        ...
                        <div style="
                                ...
                                <a href="/boats/powerboat/5-cap-camarat-center-console">
                                    CENTER CONSOLE
                                                            ...
                                                            <div>
<a class="resolve-wp" data-slug="cap-camarat-5-5-cc" href="/cap-camarat-5-5-cc">
                                            <div class="boat">
                                                                                                    <img src="https://app.jeanneau.com/uploads/boat/shape/62bac9c52298d541040229.png" alt="Cap Camarat 5.5 CC">
                                                                                                <div>
                                                    <p>CENTER CONSOLE</p>
                                                    <p class="model-name">CAP CAMARAT 5.5 CC<span
                                                                class="new"> </span>
                                                    </p>
                                                </div>
                                            </div>
                                        </a>
                                                                           <a class="resolve-wp" data-slug="cap-camarat-6-5-cc" href="  /623-cap-camarat-6-5-cc">
                                            <div class="boat">
                                                                                                    <img src="https://app.jeanneau.com/uploads/boat/shape/62bac9d6ece4b340368987.png" alt="Cap Camarat 6.5 CC">
                                                                                                <div>
                                                    <p>CENTER CONSOLE</p>
                                                    <p class="model-name">CAP CAMARAT 6.5 CC<span
                                                                class="new"> </span>
                                                    </p>
                                                </div>
                                            </div>
                                        </a>
<a class="resolve-wp" data-slug="cap-camarat-7-5-cc" href="/668-cap-camarat-7-5-cc">

                                            <div class="boat">
                                                                                                    <img src="https://app.jeanneau.com/uploads/boat/shape/62bac9f3dad94923988863.png" alt="Cap Camarat 7.5 CC">
                                                                                                <div>
                                                    <p>CENTER CONSOLE</p>
                                                    <p class="model-name">CAP CAMARAT 7.5 CC<span
                                                                class="new"> </span>
                                                    </p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="boat">
                                                                                                ...
                                                                                                <div>
                                                    <p>CENTER CONSOLE</p>
                                                    <p class="model-name">CAP CAMARAT 9.0 CC SERIE2<span
                                                                class="new"> new</span>
                                                    </p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="boat">
                                                                                                ...
                                                                                                <div>
                                                    <p>CENTER CONSOLE</p>
                                                    <p class="model-name">CAP CAMARAT 10.5 CC<span
                                                                class="new"> </span>
                                                    </p>
                                                </div>
                                            </div>
                                ...
                                <a href="/boats/powerboat/7-cap-camarat-walk-around">
                                    WALK AROUND
                                            ...
                                            <div class="boat">
                                                                                                ...
                                                                                                <div>
                                                    <p>WALK AROUND</p>
                                                    <p class="model-name">CAP CAMARAT 5.5 WA<span
                                                                class="new"> </span>
                                                    </p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="boat">
                                                                                                ...
                                                                                                <div>
                                                    <p>WALK AROUND</p>
                                                    <p class="model-name">CAP CAMARAT 6.5 WA<span
                                                                class="new"> </span>
                                                    </p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="boat">
                                                                                                ...
                                                                                                <div>
                                                    <p>WALK AROUND</p>
                                                    <p class="model-name">CAP CAMARAT 7.5 WA<span
                                                                class="new"> </span>
                                                    </p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="boat">
                                                                                                ...
                                                                                                <div>
                                                    <p>WALK AROUND</p>
                                                    <p class="model-name">CAP CAMARAT 9.0 WA<span
                                                                class="new"> </span>
                                                    </p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="boat">
                                                                                                ...
                                                                                                <div>
                                                    <p>WALK AROUND</p>
                                                    <p class="model-name">CAP CAMARAT 10.5WA<span
                                                                class="new"> </span>
                                                    </p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="boat">
                                                                                                ...
                                                                                                <div>
                                                    <p>WALK AROUND</p>
                                                    <p class="model-name">CAP CAMARAT 12.5WA<span
                                                                class="new"> </span>
                                                    </p>
                                                </div>
                                            </div>
                    ...
                    <div class="submenu-header-img">
                        ...
                        <div>
                                    ...
                                    <div class="boat">
                                            ...
                                            <p>MERRY FISHER</p>
                                            <p class="model-name">
                                                MERRY FISHER 1095 COUPÉ SERIE2
                                                <span class="new"> new</span>
                                            </p>
                                        </div>
                                    </div>
